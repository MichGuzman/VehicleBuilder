...
class Cli {
    ...
    async createCar() {
        ...
        Cli.generateVin(), ans.color, ans.make, ans.model, parseInt(ans.year), parseInt(ans.weight), parseInt(ans.topSpeed), []);
    ...
    async createTruck() {
        ...
        // DONE: The generateVin method is static and should be called using the class name Cli, make sure to use Cli.generateVin() for creating a truck and motorbike as well!
        Cli.generateVin(), ans.color, ans.make, ans.model, parseInt(ans.year), parseInt(ans.weight), parseInt(ans.topSpeed), [], parseInt(ans.towingCapacity));
        // push the car to the vehicles array
    ...
    async findVehicleToTow(_currentVehicle) {
        //Remove all listeners before an inquirer call to avoid memory leak warning
        //process.stdin.removeAllListeners();
        const ans = await inquirer.prompt([{
                type: 'list',
    ...
    async performActions() {
        //Remove all listeners before an inquirer call to avoid memory leak warning
        //process.stdin.removeAllListeners();
        const currentVehicleType = this.vehicles.find((vehicle) => this.selectedVehicleVin === vehicle.vin);
        const specialAction = (currentVehicleType) => {
